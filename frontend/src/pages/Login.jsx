    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 animate-fade-in">
        <div className="text-center">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-3">Welcome to FoodPlan</h1>
          <p className="text-lg text-gray-600">Sign in to manage your food journey</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">New to FoodPlan?</span>
              </div>
            </div>
