...
from app.models import User, UserBase, UserWithUtils, UserPublic, UserCreate, UserLogin, TokenResponse, TokenRefresh, TokenBlacklist
...
@router.get("/users/me", response_model=UserWithUtils)
